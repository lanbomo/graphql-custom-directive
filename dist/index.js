 ...
 */
function wrapFieldsWithMiddleware(type) {
  var deepWrap = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  var typeMet = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
